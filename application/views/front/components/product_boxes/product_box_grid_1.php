...
<div class="thumbnail box-style-1 no-padding" itemscope itemtype="http://schema.org/Product" id="list__viewss">
    <div class="media">
        <div class="cover"></div>
        <div class="media-link image_delay" data-src="<?php echo $img; ?>"
             style="width: 100%;height: 200px;background-image:url('<?php echo $img; ?>');background-size:cover;">
            <?php
            ...
            <div class="quick-view-sm hidden-xs hidden-sm">
                <span onclick="quick_view('<?php echo $this->crud_model->product_link($product_id, 'quick'); ?>')">
                    <span class="icon-view" data-toggle="tooltip"
                          data-original-title="<?php echo translate('quick_view'); ?>">
    ...
    <div class="caption text-center">
        ...
        <div class="rateit" data-rateit-value="<?= $rating ?>" data-rateit-ispreset="true" data-rateit-readonly="true"
        ...
        <div class="button">
            ...
            <span class="icon-view right " onclick="to_cart(<?php echo $product_id; ?>,event)" data-toggle="tooltip"
                  data-original-title="<?php if ($this->crud_model->is_added_to_cart($product_id)) {
            ...
            if ($is_affiliate && $user) {
                ...
                ?>
                <button class="btn btn-add-to <?php if ($wish == 'yes') {
                    echo 'wished';
                } else {
                    echo 'wishlist';
                } ?>" onclick="to_affliate(<?php echo $vid; ?>,event)">

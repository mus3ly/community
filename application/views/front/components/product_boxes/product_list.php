...
<div class="card card-body col-md-12 col-sm-12 col-xs-12 mb-6 mt-2 p-2">
    ...
    <div class="row product-single">
        <div class="col-md-4 col-sm-4 col-xs-12 p-0">
            <div class="media">
                <div class="cover"></div>
                <div class="media-link image_delay"  style="background-image:url('<?php echo  $img; ?>');background-size: cover;
            ...
            ?>
                ...
                <div class="buttons">
                    ...
                    if($pro->product_link){?>
                        ...
                        <a style="float: right" href="<?= $pro->product_link?>" class="btn btn-add-to cart"> Go To Shop</a>
                    <?php }else{?>
                    ...
                    <button style="background-color:#0e004a" type="submit" class="primary-btn">ADD TO CART</button>
                        ...
                        <!--<span class="btn btn-add-to cart" style="float: right" onclick="to_cart(<?php echo $product_id; ?>,event)">-->

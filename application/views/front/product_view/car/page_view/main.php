...
<div class="contact_info">
    <div class="container">
        <div class="row">
          ...
          <div class="pro_business">
                        ...
                        ?>
                            ...
                            <?php
                                ...
                                <div class="row">
                                    <div class="col-md-6 no_pdding widthout_in" id="add_rigth">
                                    ...
                                    <div class="col-md-6 no_pdding widthout_in">
                                         <div class="tag_sec_wrapper">
                                            <div class="head_section">
                                               <h4>CATEGORIES</h4> 
                                            </div>
         ...
         <div id="googleMap" style="width:100%;height:550px;margin-bottom:100px;"></div>
    </div>
</div>

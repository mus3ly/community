...
//   alert("select file");
    ...
    <body id="page-name"  ng-app="myApp" ng-controller="myCtrl">
        <button class="btn btn-danger" ng-click="update_product()">{{update_btn}}</button>
           ...
           $social_image = json_decode($pro['social_media']);
                ...
                <div class="row profile_box">
                    ...
                    <div class="col-sm-2 profile_box_img">
                        <a href="#"><img src="{{detail.comp_logo}}"  onclick="click_id('comp_logo');" alt=""></a>
                    </div>
                ...
                ?>
                            ...
                            <div class="col-sm-8 communitybox"  >
                                ...
                                <ul class="listing_none">
                                    ...
                                    <button ng-click="add_feature()">Add new feature item</button>
                                    </ul>
                                </div>

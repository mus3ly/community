...
// this function handles error
  ...
  $scope.loadTags = function(query) {
   ...
   reader.onload = function () {
     ...
     {
        //  $scope.detail.logo = reader.result;
     $('#firstImg_img').attr('src',reader.result);
     }
        ...
        <ul class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
            <li role="tab" id="headingOne" class="border__">  <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
             ...
             <input type="file" 
                ...
                <li>
                    <label>Discriptive  Image</label>
             <input type="file" id="firstImg" name='file' onchange="angular.element(this).scope().fileNameChanged('firstImg')" />
                </li>
            </ul>
            </li>
        ...
        <div class="container">
            ...
            <div class="business_banner"  style="background: url('{{detail.comp_cover}}');background-position:center;background-size:100% 100%;">
                <div class="overlay_banner__box">
                    ...
                    <a href="#" onclick="click_id('comp_cover');"><span class="img_container"><img width="50px" src="<?=base_url('/upload/logo.png')?>"></span></a>
                     </div>
                    <!--<button onclick="click_id('comp_cover');">change cover image</button>-->
                </div>
         <?php  /* ?>
            ...
            if(true)
            {
                ?>
                            ...
                            <div class="col-sm-4 business_graphic" id="business__graphic">
                                ...
                                <img src="<?= $cover; ?>" onclick="click_id('firstImg');" id="firstImg_img" alt="">
                            </div>
                        ...
                        ?>
                        <label class="switch">
  <input type="checkbox" class="checks" name="extra_info" ng-model="extra_info"  />
  <span class="slider" ng-click="change_checks('extra_info')"></span>
</label>
                        <?php
                        //extra_info

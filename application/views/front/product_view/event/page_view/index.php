    ...
    <div class="left_sec">
        <div class="main_left_wrapper">
            <div class="left_card">
              ...
              <ul>
                  <label class="main_label">Location</label>
                  <li>Faisalabad, Faisalabad District,Faisalabad, Pakistan, Faisalabad, Pakistan</li>
              </ul>
              <ul>
                  <label class="main_label">Timing</label>
                  <li>Sun May 28 2023 at 12:00 am
(Pakistan Standard Time)</li>
    ...
    <div class="right_sec">
        ...
        <div class="middle">
            <div class="img_detaile">
               <img src="<?= base_url(); ?>/upload/user.png" alt="profile image">
            </div>
            <div class="name_section">
                <span id="chang_color"><?= $vendor['company'];?></span>
                <div class="Since">
...
<!--<div class="orange_pathwrap" style="margin-top: 0;" id="orange_middle_form">-->
                        ...
                        <div class="container">
                            ...
                            <div id="googleMap" style="width:100%;height:519px;margin-bottom:100px; position: relative;z-index: -1;top: -572px;"></div>
                        </div>
                    </div>

    ...
    <div class="col-md-12">
        ...
        ?>
         ...
         <input type="hidden" name="is_blog" value="1" />
                            ...
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="blog_title"><?php echo translate('blog_title');?></label>
                                <div class="col-sm-6">
                                    <input type="text" name="title" id="blog_title" placeholder="<?php echo translate('blog_title');?>" class="form-control required">
                                </div>
                            </div>
                            <div class="form-group btm_border">

...
<div class="row">
    <div class="col-md-12">
        <?php
			echo form_open(base_url() . 'vendor/affliate/update/' . $row['compain_id'], array(
                    ...
                    <div class="tab-content">
                        <div id="bpkg_details" class="tab-pane fade active in">
						  ...
						  <!--<div class="form-group btm_border">
                                <h4 class="text-thin text-center"><?php echo translate('Edit_campaign'); ?></h4>                            
                            </div>-->
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-1"><?php echo translate('campaign_title');?></label>
                                <div class="col-sm-6">
                                    <input type="text" name="title" id="demo-hor-1" placeholder="<?php echo translate('campaign_title');?>" class="form-control required" value="<?php echo $row['title']; ?>">
                                </div>
                            </div>
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-1"><?php echo translate('target_link');?></label>
                                <div class="col-sm-6">
                                    <input type="text" name="link" id="demo-hor-1" placeholder="<?php echo translate('target_link');?>" class="form-control required" value="<?php echo $row['link']; ?>">
                                </div>
                            </div>
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-1"><?php echo translate('Percentage');?></label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-1"><?php echo translate('campaign_type');?></label>
                                <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-md-11">
                    	<span class="btn btn-purple btn-labeled fa fa-refresh pro_list_btn pull-right" 
                            onclick="ajax_set_full('edit','<?php echo translate('edit_blog'); ?>','<?php echo translate('successfully_edited!'); ?>','edit','<?php echo $row['compain_id']; ?>') "><?php echo translate('reset');?>
                        </span>
                     </div>
                     <div class="col-md-1">
                     	<span class="btn btn-success btn-md btn-labeled fa fa-wrench pull-right enterer" onclick="form_submit('campaign_update','<?php echo translate('successfully_edited!'); ?>');proceed('to_add');" ><?php echo translate('edit');?></span> 
                     </div>
                </div>
            </div>
        </form>

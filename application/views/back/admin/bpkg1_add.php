<div class="row">
    ...
    <div class="col-md-12">
		<?php
            echo form_open(base_url() . 'admin/bpkg1/do_add/', array(
                        ...
                        <div id="bpkg_details" class="tab-pane fade active in">
						  ...
						  <!--<div class="form-group btm_border">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="name" id="demo-hor-1" placeholder="<?php echo translate('menu_title');?>" class="form-control required">
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="slug" id="demo-hor-1" placeholder="<?php echo translate('slug');?>" class="form-control required">
                                </div>
                            </div>
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-1"><?php echo translate('Sort');?></label>
                                <div class="col-sm-6">
                                    <input type="text" name="position" id="demo-hor-1" placeholder="<?php echo translate('Position');?>" class="form-control required">
                                </div>
                            </div>
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-1"><?php echo translate('Vendor');?></label>
                                <div class="col-sm-6">
                                    <input type="checkbox" name="check[]" id="demo-hor-1" value="vendor"  class="form-check-input ">
                                </div>
                            </div>
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-1"><?php echo translate('Customer');?></label>
                                <div class="col-sm-6">
                                    <input type="checkbox" name="check[]" id="demo-hor-1" value="customer"  class="form-check-input ">
                                </div>
                            </div>
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-1"><?php echo translate('guest');?></label>
                                <div class="col-sm-6">
                                    <input type="checkbox" name="check[]" id="demo-hor-1" value="guest" class="form-check-input ">
                                </div>
                            </div>

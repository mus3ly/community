...
<div class="row">
    <div class="col-md-12">
        <?php
			echo form_open(base_url() . 'admin/subject/update/' . $row['id'], array(
                    ...
                    <div class="tab-content">
                        <div id="blog_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="name" id="demo-hor-1" value="<?php echo $row['subject']; ?>" placeholder="<?php echo translate('subject');?>" class="form-control required">
                                </div>
                            </div>
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-1"><?php echo translate('email');?></label>
                                <div class="col-sm-6">
                                    <input type="email" name="email" id="demo-hor-1" placeholder="" value="<?= $row['email'] ?>" class="form-control required">
                                </div>
                            </div>
            ...
            <div class="panel-footer">
                <div class="row">
                    <div class="col-md-11">
                     ...
                     <div class="col-md-1">
                     	<span class="btn btn-success btn-md btn-labeled fa fa-wrench pull-right enterer" onclick="form_submit('subject_edit','<?php echo translate('successfully_edited!'); ?>');proceed('to_add');" ><?php echo translate('edit');?></span> 
                     </div>
                </div>
            </div>
        </form>

			...
			<td id="col_<?= $row['category_id'] ?>">
             ...
             <?php 
    					...
    					foreach($brands as $row1){
    					    echo '<span class="label label-info" style="margin: 5px;font-size: 13px;">'.$row1['category_name'].'<span class="cat_del_btn" style="font-size: 16px;margin: 10px;" onclick="del_cat('.$row1['category_id'].','.$row['category_id'].',1)">x</span></span>';
    				?>
                        <!--<span class="label label-info" style="margin-right: 5px;">-->
                        <!--    <?php echo $row1['category_name'];?>-->
                        <!--    <span style="cursor:pointer;" class="del_col" onclick="del_cat('.$row1['category_id'].','.$row['category_id'].',1)">x</span>-->
                        <!--</span>-->
                   	<?php 
    					}
                        } 

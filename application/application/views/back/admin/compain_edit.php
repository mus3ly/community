...
<div class="row">
    <div class="col-md-12">
        <?php
			echo form_open(base_url() . 'admin/affliate/update/' . $row['compain_id'], array(
                    ...
                    <div class="tab-content">
                        <div id="bpkg_details" class="tab-pane fade active in">
						  ...
						  <!--<div class="form-group btm_border">
                                <h4 class="text-thin text-center"><?php echo translate('Edit_compain'); ?></h4>                            
                            </div>-->
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-1"><?php echo translate('compain_title');?></label>
                                <div class="col-sm-6">
                                    <input type="text" name="title" id="demo-hor-1" placeholder="<?php echo translate('compain_title');?>" class="form-control required" value="<?php echo $row['title']; ?>">
                                </div>
                            </div>
                            <div class="form-group btm_border">
            ...
            <div class="panel-footer">
                <div class="row">
                    <div class="col-md-11">
                     ...
                     <div class="col-md-1">
                     	<span class="btn btn-success btn-md btn-labeled fa fa-wrench pull-right enterer" onclick="form_submit('compain_update','<?php echo translate('successfully_edited!'); ?>');proceed('to_add');" ><?php echo translate('edit');?></span> 
                     </div>
                </div>
            </div>
        </form>

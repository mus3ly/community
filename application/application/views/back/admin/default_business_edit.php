...
<div class="row">
    <div class="col-md-12">
        <?php
			echo form_open(base_url() . 'admin/defaultBusiness/update/' . $row['id'], array(
                    ...
                    <div class="tab-content">
                        <div id="blog_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" disabled name="name" id="demo-hor-1" value="<?php echo $row['key']; ?>" placeholder="<?php echo translate('blog_title');?>" class="form-control required">
                                </div>
                            </div>
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-1">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="name" id="demo-hor-1" value="<?php echo $row['name']; ?>" placeholder="<?php echo translate('name');?>" class="form-control required">
                                </div>
                            </div><div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-1">
                                    <?php echo translate('value');?>
                                        </label>
                                <div class="col-sm-6">
                                    <input type="text" name="value" id="demo-hor-1" value="<?php echo $row['value']; ?>" placeholder="<?php echo translate('value');?>" class="form-control required">
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-11">
                    	<span class="btn btn-purple btn-labeled fa fa-refresh pro_list_btn pull-right" 
                            onclick="ajax_set_full('edit','<?php echo translate('edit_blog'); ?>','<?php echo translate('successfully_edited!'); ?>','blog_edit','<?php echo $row['id']; ?>') "><?php echo translate('reset');?>
                        </span>
                     </div>
                     <div class="col-md-1">

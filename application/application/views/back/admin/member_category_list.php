			...
			<tr>
				...
				<td class="text-right">
					<a class="btn btn-success btn-xs btn-labeled fa fa-wrench" data-toggle="tooltip" 
                    	onclick="ajax_modal('edit','<?php echo translate('edit_membership_category'); ?>','<?php echo translate('successfully_edited!'); ?>','member_category_edit','<?php echo $row['id']; ?>')" 
...
<?php /*	<div id='export-div'>
		<h1 style="display:none;"><?php echo translate('member_category'); ?></h1>

				...
				<div class="tab-content">
					<div class="col-md-12" style="border-bottom: 1px solid #ebebeb;padding:10px;">
						<button class="btn btn-primary btn-labeled fa fa-plus-circle pull-right" 
                        	onclick="ajax_modal('add','<?php echo translate('add_amenity_(_physical_product_)'); ?>','<?php echo translate('successfully_added!');?>','amenity_add','')">
								<?php echo translate('create_amenity');?>
						</button>
					</div>

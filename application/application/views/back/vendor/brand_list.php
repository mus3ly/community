                ...
                <tr>
                    ...
                    <td class="text-right">
                        <a class="btn btn-success btn-xs btn-labeled fa fa-wrench" data-toggle="tooltip" 
                            onclick="ajax_modal('edit','<?php echo translate('edit_brand_(_physical_product_)'); ?>','<?php echo translate('successfully_edited!'); ?>','brand_edit','<?php echo $row['textg_id']; ?>')" 
                                data-original-title="Edit" 
                                    data-container="body"><?php echo translate('edit');?>
                        </a>
                        
                        <a onclick="delete_confirm('<?php echo $row['textg_id']; ?>','<?php echo translate('really_want_to_delete_this?'); ?>')" 

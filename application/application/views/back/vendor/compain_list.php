		...
		<table id="demo-table" class="table table-striped"  data-pagination="true" data-show-refresh="true" data-ignorecol="0,4" data-show-toggle="true" data-show-columns="false" data-search="true" >
			...
			?>
                <tr>
                    ...
                    <td class="text-right">
                        <a class="btn btn-info btn-xs btn-labeled fa fa-eye" data-toggle="tooltip" 
                            onclick="ajax_modal('preview','<?php echo translate('preview_compain'); ?>',' ','edit','<?php echo $row['compain_id']; ?>')" 
                                data-original-title="Edit" 
                                    data-container="body"><?php echo translate('Preview');?>
                        </a>
                        <a class="btn btn-success btn-xs btn-labeled fa fa-wrench" data-toggle="tooltip" 
                            onclick="ajax_modal('edit','<?php echo translate('edit_package'); ?>','<?php echo translate('successfully_edited!'); ?>','edit','<?php echo $row['compain_id']; ?>')" 
                                data-original-title="Edit" 
                                    data-container="body"><?php echo translate('edit');?>
                        </a>
                        
                        <a onclick="delete_confirm('<?php echo $row['compain_id']; ?>','<?php echo translate('really_want_to_delete_this?'); ?>')" 

        ...
        <div class="row mb-2 bg-white rounded py-3">
            ...
            <div class="col-md-12">
                <div class="row terms_and_conditions p-4">
                    ...
                    ?>
                    <div class="checkbox-label term-box"><label>Terms & Conditions</label><input type="checkbox" value="" checked disabled></div>
                    <?php
                    }if(isset($row['add_affilite']) && $row['add_affilite'] == 'yes'){
                    ?>
                    <div class="checkbox-label join-box"><label>Join Affiliates</label><input type="checkbox" disabled value="" checked></div>
                    <?php
                    }if(isset($row['aff_TOC']) && $row['aff_TOC'] == 'ok'){
                    ?>
                    <div class="checkbox-label affilates-box"><label>Affiliates Terms Of Use</label><input type="checkbox" disabled value="" checked></div>
                    <?php 
                    }
                    ?>
                </div>

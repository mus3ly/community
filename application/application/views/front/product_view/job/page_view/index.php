...
<!-- big img -->
                ...
                <a href="#"><img src="https://www.communityhubland.com/template/front/images/Group-39634_06.png" alt=""/></a>
                    ...
                    ?>
                        <li><a href="<?php class="review_pd" echo $this->crud_model->product_link($pro['product_id']); ?>?rate=1"><i class="fa-solid fa-star"></i> Write a review</a></li>
        ...
        <div class="main_left_wrapper">
            <div class="left_card">
                ...
                <div class="info_wrapper new_info_wrapper">
                    <div class="main_info">
                        <?php
                        $make = $this->db->where('id',$pro['make'])->get('makes')->row_array();
                        ?>
                        <span>Make</span>
                        <span><?= $make['name']; ?></span>
                    </div>
                ...
                <div class="info_wrapper new_info_wrapper">
                    <div class="main_info">
                        ...
                        <span><?= $pro['distance_covered'].' '.$pro['uom']; ?></span>
                    </div>
                </div>
                <div class="info_wrapper">
                    <div class="main_info">
...
<div class="info_box_wrap">
    <div class="container">
        ...
        <!-----------display none on style.css line no:357--------------->
        ...
        <div class="row hide_bp" id="volume_box">

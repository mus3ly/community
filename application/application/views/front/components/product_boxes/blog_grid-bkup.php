...
<div class="col-sm-12 col-md-4 p-2">
    <div class="card card-body">
             ...
             <div class="row">
             <div class=" col-12 img_col row" onclick="location.href='<?= $this->crud_model->product_link($product_id); ?>'">
             <?php
             if($is_blog == 1){?>
                  ...
                  <div class="logo_withname">
                   ...
                   <a onclick="to_wishlist(<?php echo $product_id; ?>,event)"><i class="fa fa-heart"></i></a>
                    ...
                    ?>
                        ...
                        <div class="blogs_titlee" style="height:70px;"><h1><?= substr($title, 0, 88) ?></h1></div>
                        <div class="meddle_cont" style="height: 60px;">
                    ...
                    ?>
                        ...
                        <div class="last_desc" style="padding:10px;">

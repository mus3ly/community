...
slider.oninput = function() {
  this.style.background = `linear-gradient(to right, #f36022 0%, #f36022 ${(this.value-this.min)/(this.max-this.min)*100}%, #DEE2E6 ${(this.value-this.min)/(this.max-this.min)*100}%, #DEE2E6 100%)`
};
